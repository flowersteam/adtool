...
const DOM_IDS = {
    ...
    goalTargetingSection: "goalTargetingSection",
    goalZoneSupportText: "goalZoneSupportText",
    goalZoneControls: "goalZoneControls",
    goalZonePlacementButton: "goalZonePlacementButton",
    goalZoneClearButton: "goalZoneClearButton",
    goalZoneUnsupportedMessage: "goalZoneUnsupportedMessage",
    goalZoneRadiusControl: "goalZoneRadiusControl",
    goalZoneRadiusInput: "goalZoneRadiusInput",
    goalZoneRadiusValue: "goalZoneRadiusValue",
    goalZoneList: "goalZoneList",
    ...
    checkpointTreeSection: "checkpointTreeSection",
    checkpointTreeToggleButton: "checkpointTreeToggleButton",
    checkpointTree: "checkpointTree",
    checkpointTreeHoverLabel: "checkpointTreeHoverLabel",
