...
from adtool.auto_disc.explorers import BaseExplorer

from adtool.auto_disc.utils.spaces import BoxSpace, DictSpace
...
@dataclass
class xIMGEPExplorerConfig(Defaults):
...
@xIMGEPExplorerConfig.expose_config()
