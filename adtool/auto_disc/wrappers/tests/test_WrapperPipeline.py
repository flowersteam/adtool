...
import pytest
from adtool.auto_disc.wrappers import SaveWrapper, WrapperPipeline
from adtool.utils.leaf.Leaf import Leaf, StatelessLocator
from adtool.utils.leaf.locators.Locator import FileLocator
