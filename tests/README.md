...
- Run:
  python3 run_tests.py --only my_example --refresh-baseline
...
- Run a subset:
  python3 run_tests.py --only my_example other_example
...
- Runs run.py with a temporary config and isolated save directory
