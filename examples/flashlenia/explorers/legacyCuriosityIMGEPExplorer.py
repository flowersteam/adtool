"""
This module is the old implementation of the curiosity-driven IMGEP explorer.
It's kept so people can validate the new implementation properly as the new implementation
might be slighlty different in behavior.
"""
