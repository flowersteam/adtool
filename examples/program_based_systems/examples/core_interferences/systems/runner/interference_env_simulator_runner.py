...
from examples.program_based_systems.systems.runner.program_based_systems_simulator_runner import (
    BaseSimulatorRunner,
)
from examples.program_based_systems.types import Simulator
...
class Experiment:
        ...
        if type(ddr_stats) != type(None):
            for key in ddr_stats:
                if key in self.ddr_stats and key != 'completion_time':
                    ...
                    self.time_values[['core0', 'core1']
                                     [ddr_stats['core']]].append(ddr_stats[key])
                else:
    ...
    def reorder(self):
        ...
        def type2id(type_): return 0 if type_ == 'read' else 1
...
class Env:
    ...
    def __call__(self, parameter: dict) -> dict:
        ...
        # ddr targets
        out['mutual']['diff_time_core0'] = out['mutual']['time_core0'] - \
            out['core0']['time_core0']
        out['mutual']['diff_time_core1'] = out['mutual']['time_core1'] - \
            out['core1']['time_core1']
        out['mutual']['diff_time'] = out['mutual']['time_core1'] - \
            out['mutual']['time_core0']
        ...
        out['mutual']['miss_read_core0'] = out['mutual']['miss_read'] - \
            out['core0']['miss_read']
        out['mutual']['miss_read_core1'] = out['mutual']['miss_read'] - \
            out['core1']['miss_read']
        out['mutual']['miss_write_core0'] = out['mutual']['miss_write'] - \
            out['core0']['miss_write']
        out['mutual']['miss_write_core1'] = out['mutual']['miss_write'] - \
            out['core1']['miss_write']
        out['mutual']['hits_read_core0'] = out['mutual']['hits_read'] - \
            out['core0']['hits_read']
        out['mutual']['hits_read_core1'] = out['mutual']['hits_read'] - \
            out['core1']['hits_read']
        out['mutual']['hits_write_core0'] = out['mutual']['hits_write'] - \
            out['core0']['hits_write']
        out['mutual']['hits_write_core1'] = out['mutual']['hits_write'] - \
            out['core1']['hits_write']
        # L2 targets
        out['mutual']['L2_miss_core0'] = out['mutual']['L2_miss'] - \
            out['core0']['L2_miss']
        out['mutual']['L2_hit_core0'] = out['mutual']['L2_hit'] - \
            out['core0']['L2_hit']
        out['mutual']['L2_miss_core1'] = out['mutual']['L2_miss'] - \
            out['core1']['L2_miss']
        out['mutual']['L2_hit_core1'] = out['mutual']['L2_hit'] - \
            out['core1']['L2_hit']

        out['mutual']['L2_miss_read_core0'] = out['mutual']['L2_miss_read'] - \
            out['core0']['L2_miss_read']
        out['mutual']['L2_hit_read_core0'] = out['mutual']['L2_hit_read'] - \
            out['core0']['L2_hit_read']
        out['mutual']['L2_miss_read_core1'] = out['mutual']['L2_miss_read'] - \
        ...
        out['mutual']['L2_hit_write_core0'] = out['mutual']['L2_hit_write'] - \
            out['core0']['L2_hit_write']
        out['mutual']['L2_miss_write_core1'] = out['mutual']['L2_miss_write'] - \
            out['core1']['L2_miss_write']
