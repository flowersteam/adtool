...
import graphviz
import torch
from adtool.auto_disc.input_wrappers.generic.cppn.pytorchneat.activations import (
    str_to_activation,
)
from adtool.auto_disc.input_wrappers.generic.cppn.pytorchneat.aggregations import (
    str_to_aggregation,
)
