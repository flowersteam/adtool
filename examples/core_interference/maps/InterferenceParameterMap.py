...
class InterferenceParameterMap(Leaf):
    ...
    def __init__(
            ...
            generator_config: Optional[Dict[str, Any]] = {
                "path": "examples.core_interference.generators.random_instruction_generator.RandomInstructionGenerator"
            },
            mutator_config: Optional[Dict[str, Any]] = {
                "path": "examples.core_interference.mutators.random_instruction_mutator.RandomInstructionMutator",
                "num_mutations": 2,
            },
